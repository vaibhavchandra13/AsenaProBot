...
In both cases Asena will help you.
...
<code>(file)</code>: required file, if file isn't provided you will be entered in file state, this means Asena will wait file message from you. Type /cancel to leave from it.
