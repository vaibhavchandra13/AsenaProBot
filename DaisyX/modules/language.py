...
async def select_lang_keyboard(message, strings, edit=False):
    ...
    markup.add(
        InlineKeyboardButton(
            strings["crowdin_btn"], url="https://t.me/GreyWolfXD"
        )
    )
    if edit:
...
__help__ = """
This module is dedicated towards utlising Asena's localization feature!
...
Asena will send you bunch of inline buttons where you can select your prefered language interatively without any hassles!
"""
