...
async def _(event):
    ...
    packshortname = f"Asena_stickers_{userid}"
    kanga = await event.reply("Hello, This Sticker Looks Noice. Mind if Asena steal it")
    ...
    if is_a_s:
        ...
        packshortname = f"Asena_animated_{userid}"
